      ...
      {hasMore && messages.length > 0 && (
        <div className="flex justify-center py-2">
          <button
            ...
            className="px-4 py-2 text-xs font-medium text-text-muted hover:text-primary bg-white border border-border rounded-full hover:border-primary/30 transition-smooth disabled:opacity-50"
          >
            {loadingMore ? (
