    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center p-4" style={{ background: '#212121' }}>
          <div className="w-full max-w-sm rounded-2xl p-8 text-center" style={{ background: '#2f2f2f', border: '1px solid rgba(255,255,255,0.1)' }}>
            <div className="w-14 h-14 mx-auto mb-5 rounded-full flex items-center justify-center" style={{ background: 'rgba(248,113,113,0.1)', border: '1px solid rgba(248,113,113,0.2)' }}>
