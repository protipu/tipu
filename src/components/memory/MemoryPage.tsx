    ...
    <div className="flex-1 flex flex-col h-full relative z-10">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-2">
        <div className="max-w-lg mx-auto space-y-2.5">
          ...
          {!loading && error && (
            <div className="glass-light border border-error/20 rounded-2xl p-4 text-center animate-slide-up">
              <p className="text-sm text-error">{error}</p>
              <button onClick={loadMemories} className="mt-2 text-xs font-medium text-primary hover:text-primary-hover transition-smooth">
                Try again
              </button>
            </div>
          )}
